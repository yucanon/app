 ...
 *
 * @property \App\Model\Table\AdminJobsTable $AdminNursingHomes
 *
...
class AdminNursingHomesController extends AppController
{
    ...
    {
        if (isset($admin['role']) && $admin['role'] === '2') {
            return true;
        }
    ...
    public function index()
    {
        ...
        $adminJobs = $this->paginate($this->AdminNursingHomes->find()->where(['admins_id' => $this->authadmin['id']]));
