...
/**
 * AdminJobs Controller
 *
 * @property \App\Model\Table\AdminJobsTable $AdminJobs
 *
 * @method \App\Model\Entity\AdminJob[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
class AdminJobsController extends AppController
{
    public $authadmin;
    ...
    public function index()
    {
        ...
        $adminJobs = $this->paginate($this->AdminJobs->find()->where(['admins_id' => $this->authadmin['id']]));
