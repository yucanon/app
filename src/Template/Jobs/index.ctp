...
<div class="adminJobs index large-12" style = "width:80%; top: 0; bottom: 0; left: 0; right: 0; margin: auto;">
<script type="text/javascript">

    <!-- 地域検索機能 -->
    <?= $this->element('Search/search_area') ?>
    ...
    <?php foreach ($adminJobs as $adminJob): ?>
        ...
        <tbody>
            ...
            <div class = "flex">
            <?= $this->Html->link(__('WEB応募'), ['action' => 'create', $adminJob->id], ['class' => 'button a', 'style' => 'color: black; background-color:white;']) ?>
                <?= $this->Form->postLink(__('TEL応募'), ['action' => 'delete', $adminJob->id], ['confirm' => __('Are you sure you want to delete # {0}?', $adminJob->id), 'class' => 'button a', 'style' => 'color: black; background-color:white;']) ?>
            </div>
            <?php } else {?>
            <div class ="box">
